...
const Header1 = (props) => {
  return (
    <header className={`header1-header ${props.rootClassName} `}>
      <img
        alt={props.image_alt}
        src={props.image_src}
      ...
      <div className="header1-nav">
        <NavigationLinks
          rootClassName="navigation-links-root-class-name2"
          className=""
        ></NavigationLinks>
      </div>
      <div className="header1-btn-group">
        <button className="header1-button button">{props.button}</button>
        <button className="button">{props.button1}</button>
      </div>
      <div className="header1-menu-burger teleport-menu-burger">
      ...
      <div className="teleport-menu-mobile header1-menu-mobile">
        <div className="header1-nav1">
          ...
          <NavigationLinks
            rootClassName="navigation-links-root-class-name3"
            className=""
          ></NavigationLinks>
        </div>
        <div className="">
